...
export function minErr(module: string, ErrorConstructor: any) {
...
export function valueFn(value) {return function valueRef() {return value;};}
...
export var trim = function(value) {
...
export var escapeForRegexp = function(s) {
